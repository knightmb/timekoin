	...
	if($_GET["menu"] == "tools")
	{
		...
		if(empty($_GET["action"]) == TRUE)
		{
			...
			$body_string = '<strong>Showing Last <font color="blue">' . $show_last . '</font> Log Events</strong>' . $filter_by . '<table border="0" cellspacing="5"><tr><td>
				...
				<option value="R">Generation Request</option><option value="MA">Main Program</option><option value="TC">Transaction Queue Clerk</option><option value="T">Transactions</option>
				<option value="TR">Treasurer Processor</option></select></td></tr></table>
