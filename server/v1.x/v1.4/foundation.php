	...
	if($sql_num_results > 0)
	{
		...
		if(empty($current_foundation_hash) == FALSE)
		{
			for ($i = 0; $i < $sql_num_results; $i++)
			{
				...
				$poll_peer = filter_sql(file_get_contents("http://$site_address:$port_number/$subfolder/foundation.php?action=block_hash&block_number=$rand_block", FALSE, $context, NULL, 65));
