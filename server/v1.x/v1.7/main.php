	...
	//*****************************************************************************************************
		...
		if($script_loop_active == 0)
		{
			...
			else
			{
				...
				exec("php transclerk.php &> /dev/null &"); // This will execute without waiting for it to finish
			}			
		}
		...
		if($script_loop_active == 0)
		{
			...
			{
				// Call transclerk management script
				exec("php foundation.php &> /dev/null &"); // This will execute without waiting for it to finish
			}			
		}
		...
		if($script_loop_active == 0)
		{
			...
			else
			{
				...
				exec("php generation.php &> /dev/null &"); // This will execute without waiting for it to finish
			}			
		}
		...
		if($script_loop_active == 0)
		{
			...
			else
			{
				...
				exec("php treasurer.php &> /dev/null &"); // This will execute without waiting for it to finish
			}
		}
		...
		if($script_loop_active == 0)
		{
			...
			else
			{
				...
				exec("php peerlist.php &> /dev/null &"); // This will execute without waiting for it to finish
			}
		}
		...
		if($script_loop_active == 0 || $script_loop_active == 1)
		{
			...
			else
			{
				...
				exec("php queueclerk.php &> /dev/null &"); // This will execute without waiting for it to finish
			}			
		}
		...
		if($script_loop_active == 0)
		{
			...
			else
			{
				...
				exec("php genpeer.php &> /dev/null &"); // This will execute without waiting for it to finish
			}			
		}
