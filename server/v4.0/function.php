...
function check_for_updates($code_feedback = FALSE)
{
	...
	{
		$update_check1 .= '<strong><font color="red">ERROR: Could Not Contact the Server https://timekoin.net</font></strong>';
	}
...
function do_updates()
{
	...
	{
		$update_status .= '<font color="red"><strong>ERROR: Could Not Contact the Server https://timekoin.net</strong></font>';
	}
