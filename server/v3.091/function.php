...
define("TIMEKOIN_VERSION","3.091"); // This Timekoin Software Version
define("NEXT_VERSION","current_version30.txt"); // What file to check for future versions
...
function queue_hash()
{
	$sql = "SELECT public_key, crypt_data1, crypt_data2, crypt_data3, hash, attribute FROM `transaction_queue` GROUP BY `hash` ORDER BY `hash` ASC";
	$sql_result = mysql_query($sql);
	$sql_num_results = mysql_num_rows($sql_result);
