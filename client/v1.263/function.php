...
define("TIMEKOIN_VERSION","1.263"); // This Timekoin Software Version
...
function do_updates()
{
	...
	if(empty($poll_version) == FALSE)
	{
		...
		$update_status .= 'Checking for <strong>Graphic File timekoin_history.png</strong> Update...<br>';
		$update_status .= run_script_update("Graphic File (timekoin_history.png)", "timekoin_history.png", $poll_version, $context, 0, "img");
		...
		$update_status .= 'Checking for <strong>Graphic File timekoin_send.png</strong> Update...<br>';
		$update_status .= run_script_update("Graphic File (timekoin_send.png)", "timekoin_send.png", $poll_version, $context, 0, "img");
		//****************************************************
