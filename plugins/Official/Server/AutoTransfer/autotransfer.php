...
if($_SESSION["valid_login"] == FALSE)
{
	...
	for ($i = 0; $i < $sql_num_results; $i++)
	{
		...
		$tx_key3 = find_string("---key3=", "---delay", $sql_row["field_data"]); // Public Key To
...
Task Name:</td><td><input type="text" size="20" name="taskname" /></td></tr>
<tr><td align="right">
Type:</td><td><select name="type">
<option value="delay">Countdown Delay</option>
</select></td></tr>
<tr><td>
From Private Key:</td><td>
<textarea name="fromprivatekey" rows="6" cols="75"></textarea>
</td></tr>
<tr><td>
From Public Key:</td><td>
<textarea name="frompublickey" rows="6" cols="75"></textarea>
</td></tr>
<tr><td colspan="2"><hr></td></tr>
<tr><td>
To Public Key:</td><td>
<textarea name="topublickey" rows="6" cols="75"></textarea>
</td></tr>
<tr><td align="right">
Amount:</td><td><input type="text" size="16" name="amount" /></td></tr>
<td align="right">
Delay:</td><td>
...
<tr><td><input type="submit" name="Submit" value="Save Task" /></td><td></td></tr></table>
		...
		$quick_info = 'Delay does a currency transfer after a countdown of the chosen amount of days, hours, or minutes';
...
function autotx_home()
{
	...
	for ($i = 0; $i < $sql_num_results; $i++)
	{
		...
		if($tx_type == "delay")
		{
			...
			{
				$tx_conditions = "$tx_delay" . "s Remainig";
			}
		...
		<td><p style="word-wrap:break-word; width:90px; font-size:' . $default_public_key_font . 'px;">' . $tx_key3 . '</p></td><td>' . $tx_amount . '</td><td valign="top" align="center">' . $tx_toggle . '</td>
...
return '<table border="1" cellpadding="2" cellspacing="10"><tr><td valign="bottom" align="center" colspan="8"><strong>Auto Currency Transfer Task List</strong>
</td></tr>
...
<td align="center"><strong>Key From</strong></td><td align="center"><strong>Key To</strong></td><td align="center"><strong>Amount</strong></td>
...
<tr><td align="right" colspan="8"><FORM ACTION="autotransfer.php?task=new" METHOD="post"><input type="submit" name="SubmitNew" value="Create New Task" /></FORM></td></tr>
	...
	$quick_info = 'Auto Transfers happen at specified intervals.<br><br>Condtional Transfers have a set of rules that must be met before the transfer takes place.';


	home_screen("Auto Currency Transfer", $text_bar, $body_string, $quick_info , AUTOCHECK, TRUE);
