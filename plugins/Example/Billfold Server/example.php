...
// functions, database, and templates of Timekoin Client.
//
// Timekoin Client will parse the file looking for these text strings
...
session_name("tkbillfoldserver"); // Continue Session Name, Default: [tkbillfoldserver]
...
if($_SESSION["valid_login"] == TRUE) // Make Sure Login is Still Valid
{
	...
	home_screen($section_string, $text_bar, $body_string, $quick_info , $update, TRUE, "Example");
