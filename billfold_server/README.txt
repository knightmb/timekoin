...
Timekoin is an open source peer to peer based cryptocurrency system. As such,
...
2. PHP5 (+PHP7 recommended) for the Web Server, including the CLI, mySQLi, GMP, and
...
1.  Checklist Requirements:
	...
	A. Verify that your web server has installed, PHP5 (with mySQLi, GMP, CLI, 
...
our database “tk_billfold_db” in this document.
...
named it “tk_billfold” (how original). Be sure to set a good password for this
account.
...
“tkbillfold” for these instructions. Copy all the files from the v1.X folder to
this new web folder. Make sure your directory structure stays intact so that the
“css” and “img”, etc. folders make it properly to their new home.
...
“tk_billfold_server.sql”. This contains a complete layout of a fresh new timekoin
client billfold database. You can simply import it directly into your new Timekoin
database either via command line or from a web gui (like phpMyAdmin for example). This
will create all the tables and data you need to continue on to the next steps of
installation.


5. Login to new Billfold Client Server
...
generate a new random Private and Public key pair. You can skip this step if
you only plan to use the admin login to check on the system operations.
...
of your Timekoin Billfold Client server software.
