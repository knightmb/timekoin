...
function options_screen()
{
	...
	if($_GET["newkeys"] == "generate")
	{
		...
		$form_action = '<FORM ACTION="index.php?menu=options&amp;newkeys=confirm" METHOD="post"><strong>Bits Size [1,536 to 10,240]</strong> (Caution: High Values Take a Lot of Time to Generate!) <input type="number" name="new_key_bits" min="1536" max="10240" size="6" value="1536" onclick="showWait()" /><br><br>';
	}
	else
	{
